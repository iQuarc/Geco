...
namespace Geco.DataSync
{
    ...
    /// </summary>
    [Options(typeof(EntityFrameworkCoreSyncModelGeneratorOptions))]
    public class EntityFrameworkCoreSyncModelGenerator : BaseGeneratorWithMetadata
    {
        private readonly EntityFrameworkCoreSyncModelGeneratorOptions options;

        public EntityFrameworkCoreSyncModelGenerator(IMetadataProvider provider, IInflector inf, EntityFrameworkCoreSyncModelGeneratorOptions options) : base(provider, inf, options.ConnectionName)
        {
